...
- Voor een overzicht van je verzamelde aanwijzingen typ 'hints' in het 'ga naar'-veld.
- Wil je de spelregels opnieuw inzien? Typ 'help' in het 'ga naar'-veld.
...
keuken_actie2 = '2. Bekijk de deur naar de ketelruimte'
keuken_resultaat1 = '''
...
'''
studio_actie1 = '1. Haal kleding van het wasrek.'
...
toilet3_resultaat1 = '\nHey, je hebt nog een papiertje in je inventaris. Dit hiervoor gebruiken?'
toilet_resultaat2 = '\nHet is lastig zien in een tekstueel avontuur, maar het toiletpapier is OP. Jammer joh!'
toilet_resultaat_a = '''
PAPIERTJE GEBRUIKT.
Je hebt het zilvervisje nu gedood. Maar dacht je nu echt dat je hier een hint mee kon vinden? Helaas.
...
'''
washok_actie1 = '1. Schouders ophalen en deur dichtdoen.'
washok_actie2 = '2. Wasmachine openen.'
washok_resultaat1 = '\nIk zou toch even kijken...'
washok1_resultaat2 = '\nWat zit er toch in? Het is geen kleding. Inhoud verwijderen?'
...
hint1 = 'Een papiertje met daarop geschreven: a needle in a HAYstack.'
hint2 = ''' Het keyboard wat de volgende noten speelt:
   kort lang lang lang pauze
   lang lang kort kort kort pauze
   lang lang kort kort kort pauze
'''
hint3 = '''Een schilderij van Julius Caesar die een bordje vasthoudt. 
  Op het bordje staat de letter 'V'
'''
hint4 = "Bierviltjes met daarop de woorden 'mjy', 'fhmyjw', en 'ltwinos'.\n"
